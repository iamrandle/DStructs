...
////  file.
//int hashfunct(const WordQueue& wq)
//{
...
//
//for both read and print, every element in the set must be visited. In an Array, you simply go to the straight to the inde
